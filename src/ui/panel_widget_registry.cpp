...
static std::vector<PanelWidgetDef> s_widget_defs = {
    ...
    {"thermistor",       "Temp Sensor",       "thermometer",      "Monitor temperature sensors (single or carousel)", "Temp Sensor",  "temp_sensor_count",  "No temperature sensors detected",     false, 1, 1, 1, 1, 2, 1, true},
